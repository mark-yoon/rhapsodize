...
//                LegacySettingsActivity.this.finish();
//            }
//        });
        ...
        if (getIntent().getBooleanExtra("EXIT", false))
        {
            ...
            // TODO
//            int[] prefs = new int[2];
//            prefs[0] = R.xml.pref_general;
//            prefs[1] = R.xml.pref_general;
//
//            //After clicking on "save"
//            Intent intent = new Intent();
//            intent.putExtra("valueId", prefs); //value should be your string from the edittext
